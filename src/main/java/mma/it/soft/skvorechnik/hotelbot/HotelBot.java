...
public class HotelBot extends TelegramLongPollingBot {
    ...
    private void handleCallbackQuery(CallbackQuery callbackQuery) {
        ...
        switch (callbackData) {
            ...
            case "question_9" -> {
                message.setText("Мы принимаем воспитаных собак небольших пород до 35см в холке и весом не более 10кг. Необходимо сообщать породу собаки при бронировании.\n" +
            ...
            case "question_11" -> {
                message.setText("Детской площадки на территории нет. Ближайшая площадка находится в центре поселка - около Стрелковой ул.4 ( 20 минут пешком), так же детская площадка есть на пляже Морские Дубки, и возле магазина Реалъ \n" +
